...
import { useTheme } from '../context/ThemeContext'; // Adaptar a la ruta correcta donde tienes tu ThemeProvider
...
const Hero: React.FC<HeroProps> = ({ openPortfolioModal }) => {
  ...
  const handleOpenPortfolio = () => {
    ...
    if (openPortfolioModal) openPortfolioModal();
  };
  ...
  return (
    <div className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <button 
        onClick={toggleTheme}
        className="absolute top-4 right-4 z-50 bg-white dark:bg-gray-800 p-2 rounded-full shadow-lg text-gray-800 dark:text-white transition-all duration-300"
      >
      ...
      <div
        ...
        style={{
          backgroundImage: isDarkMode ? "url('/images/dark-bg.png')" : "url('/images/primera.png')",
        }}
      >
                ...
                <div className="flex space-x-6">
                  <button 
                    ...
                    className={`py-3 border-b-2 transition-colors ${
                      selectedTab === 'todos' 
                        ? (isDarkMode ? 'border-purple-500 text-purple-500' : 'border-blue-500 text-blue-600') 
